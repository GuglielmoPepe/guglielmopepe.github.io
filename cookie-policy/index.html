...
<html lang="en">
    ...
    <head>
        ...
        <title>Cookie policy | Guglielmo Pepe</title>
        ...
        <main>
            ...
            <article>
                ...
                <header>
                    ...
                    <h1>Information about cookies and other tracking systems</h1>
                ...
                <section>
                    ...
                    <p>Cookies are text files that websites send to users' terminals when they visit them, which are then retransmitted to the websites themselves upon their next visit. Cookies can be divided into two main categories: "profiling cookies" and "technical cookies."</p>

                    <p>This site does not use cookies.</p>

                    <p>At this time, the site does not respond to “Do Not Track” beacons sent by browser plugins.</p>
